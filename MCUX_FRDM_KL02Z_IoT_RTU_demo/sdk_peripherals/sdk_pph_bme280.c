...
//------------------------------------
 status_t bme280WhoAmI(void) {
	...
	status = i2c1MasterReadByte(&i2c_data, 1, BME280_ADDRESS, BME280_REG_ID);
 ...
 status_t bme280Init(void){
    ...
    /*  write 00000 101 = 0x05 to CTRL_HUM */
 	...
 	i2c_data = 0x05;
 	status = i2c1MasterWriteByte(&i2c_data, 1, BME280_ADDRESS, BME280_REG_CTRL_HUM);
    ...
    /*  write 101 101 11 = 0xB7 to CTRL_MEAS */
 	...
 	/*  [1-0] = 11 	Normal Mode*/
 	i2c_data = 0xB7;
 	status = i2c1MasterWriteByte(&i2c_data, 1, BME280_ADDRESS, BME280_REG_CTRL_MEAS);
...
status_t bme280ReadData(bme280_data_t *data) {
	...
	status = i2c1MasterReadByte(&i2c_data[0], 8, BME280_ADDRESS, BME280_REG_PRESS_MSB);
	if (status == kStatus_Success) {
